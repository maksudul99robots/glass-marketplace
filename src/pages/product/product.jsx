    ...
    <div>
      <div className='max-w-screen-xl mx-auto my-10 flex gap-10'>
        <div className='w-3/5 relative'>
          <img className='w-full h-[550px]' src={details.image} alt="" />
        ...
        <div className='w-2/5 flex flex-col justify-center gap-12'>
            ...
            <div className='flex align-center gap-3 flex-start'>
              ...
              <button className='border h-10 text-black font-normal text-1g flex items-center justify-center px-2 hover:bg-gray-700 hover:text-white cursor-pointer py-3 duration-300 active:bg-black'>
                Tryon
              </button>
